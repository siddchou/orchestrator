...
`],encapsulation:2})}return a})(),Oe=(()=>{class a{static \u0275fac=function(n){return new(n||a)};static \u0275mod=tE({type:a});static \u0275inj=Hl({imports:[ct,Un$1]})}return a})();function ka(a,o){if(a&1&&(fi(0,"mat-option",5),vD(1),Sc()),a&2){let e=o.$implicit;Mp("value",e),Tv(),Kp(e);}}var ze=class a{fb=T(eh);dialogRef=T(v);data=T(se);stepTypes=["ENV_SETUP","LOG_CLEANUP","JAVA_EXEC","SFTP","ARCHIVE"];form;constructor(){this.form=this.fb.group({stepName:[this.data.stepName,br.required],stepType:[this.data.stepType,br.required],stepConfig:[this.data.stepConfig||"{}"],continueOnFailure:[this.data.continueOnFailure],enabled:[this.data.enabled]});}onSubmit(){this.form.invalid||this.dialogRef.close(q({stepId:this.data.stepId},this.form.value));}onCancel(){this.dialogRef.close();}static \u0275fac=function(e){return new(e||a)};static \u0275cmp=XI({type:a,selectors:[["app-step-form-dialog"]],decls:28,vars:2,consts:[["mat-dialog-title",""],[3,"formGroup"],["appearance","outline"],["matInput","","formControlName","stepName","required",""],["formControlName","stepType"],[3,"value"],["matInput","","formControlName","stepConfig","rows","4"],[1,"checkbox-row"],["formControlName","continueOnFailure"],["formControlName","enabled"],["align","end"],["mat-button","",3,"click"],["mat-flat-button","","color","primary",3,"click"]],template:function(e,n){e&1&&(fi(0,"h2",0),vD(1),Sc(),fi(2,"mat-dialog-content")(3,"form",1)(4,"mat-form-field",2)(5,"mat-label"),vD(6,"Step Name"),Sc(),Np(7,"input",3),uI(),Sc(),fi(8,"mat-form-field",2)(9,"mat-label"),vD(10,"Step Type"),Sc(),fi(11,"mat-select",4),NE(12,ka,2,2,"mat-option",5,ME),Sc(),uI(),Sc(),fi(14,"mat-form-field",2)(15,"mat-label"),vD(16,"Step Config (JSON)"),Sc(),Np(17,"textarea",6),uI(),Sc(),fi(18,"div",7)(19,"mat-checkbox",8),vD(20,"Continue on failure"),Sc(),uI(),fi(21,"mat-checkbox",9),vD(22,"Enabled"),Sc(),uI(),Sc()()(),fi(23,"mat-dialog-actions",10)(24,"button",11),Op("click",function(){return n.onCancel()}),vD(25,"Cancel"),Sc(),fi(26,"button",12),Op("click",function(){return n.onSubmit()}),vD(27,"Save"),Sc()()),e&2&&(Tv(),Kp(n.data.stepId?"Edit Step":"Add Step"),Tv(2),Mp("formGroup",n.form),Tv(4),fI(),Tv(4),fI(),Tv(),SE(n.stepTypes),Tv(5),fI(),Tv(2),fI(),Tv(2),fI());},dependencies:[Xi,nh,Qf,To,Xf,qf,$o,Oc,xc,F,jt,we,Ke$1,Ge$1,vg,bg,bi,yi,j,Oe,ct,Ue,We,qe,Qe],styles:["mat-dialog-content[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:16px;min-width:350px}.checkbox-row[_ngcontent-%COMP%]{display:flex;gap:24px}"]})};function va(a,o){a&1&&(fi(0,"mat-error"),vD(1,"Job name is required"),Sc());}function xa(a,o){a&1&&(fi(0,"mat-error"),vD(1,"Working directory is required"),Sc());}function ya(a,o){if(a&1){let e=PE();fi(0,"button",13),Op("click",function(){du(e);let t=$E(2);return fu(t.saveGeneral())}),vD(1,"Save"),Sc();}}function Ca(a,o){if(a&1){let e=PE();fi(0,"button",13),Op("click",function(){du(e);let t=$E(2);return fu(t.createNewJob())}),vD(1,"Create Job"),Sc();}}function Ta(a,o){a&1&&(fi(0,"th",27),vD(1,"#"),Sc());}function Ia(a,o){if(a&1&&(fi(0,"td",28),vD(1),Sc()),a&2){let e=o.$implicit;Tv(),Kp(e.stepOrder);}}function wa(a,o){a&1&&(fi(0,"th",27),vD(1,"Name"),Sc());}function Da(a,o){if(a&1&&(fi(0,"td",28),vD(1),Sc()),a&2){let e=o.$implicit;Tv(),Kp(e.stepName);}}function Ea(a,o){a&1&&(fi(0,"th",27),vD(1,"Type"),Sc());}function Sa(a,o){if(a&1&&(fi(0,"td",28)(1,"mat-chip"),vD(2),Sc()()),a&2){let e=o.$implicit;Tv(2),Kp(e.stepType);}}function Ma(a,o){a&1&&(fi(0,"th",27),vD(1,"Continue on Fail"),Sc());}function Ra(a,o){if(a&1&&(fi(0,"td",28),vD(1),Sc()),a&2){let e=o.$implicit;Tv(),Oc$1(" ",e.continueOnFailure?"Yes":"No"," ");}}function Pa(a,o){a&1&&(fi(0,"th",27),vD(1,"Enabled"),Sc());}function Ba(a,o){if(a&1&&(fi(0,"td",28),vD(1),Sc()),a&2){let e=o.$implicit;Tv(),Oc$1(" ",e.enabled?"Yes":"No"," ");}}function La(a,o){a&1&&(fi(0,"th",27),vD(1,"Actions"),Sc());}function Aa(a,o){if(a&1){let e=PE();fi(0,"td",28)(1,"button",29),Op("click",function(){let t=du(e).$implicit,i=$E(3);return fu(i.openStepForm(t))}),fi(2,"mat-icon"),vD(3,"edit"),Sc()(),fi(4,"button",30),Op("click",function(){let t=du(e).$implicit,i=$E(3);return fu(i.deleteStep(t))}),fi(5,"mat-icon"),vD(6,"delete"),Sc()()();}}function Fa(a,o){a&1&&Np(0,"tr",31);}function Na(a,o){a&1&&Np(0,"tr",32);}function ja(a,o){if(a&1){let e=PE();fi(0,"mat-tab",10)(1,"div",14)(2,"button",15),Op("click",function(){du(e);let t=$E(2);return fu(t.openStepForm())}),fi(3,"mat-icon"),vD(4,"add"),Sc(),vD(5," Add Step "),Sc(),fi(6,"table",16),Rc(7,17),Ep(8,Ta,2,0,"th",18)(9,Ia,2,1,"td",19),kc(),Rc(10,20),Ep(11,wa,2,0,"th",18)(12,Da,2,1,"td",19),kc(),Rc(13,21),Ep(14,Ea,2,0,"th",18)(15,Sa,3,1,"td",19),kc(),Rc(16,22),Ep(17,Ma,2,0,"th",18)(18,Ra,2,1,"td",19),kc(),Rc(19,23),Ep(20,Pa,2,0,"th",18)(21,Ba,2,1,"td",19),kc(),Rc(22,24),Ep(23,La,2,0,"th",18)(24,Aa,7,0,"td",19),kc(),Ep(25,Fa,1,0,"tr",25)(26,Na,1,0,"tr",26),Sc()()();}if(a&2){let e=$E(2);Mp("label",wD("Steps (",e.job.steps.length,")")),Tv(6),Mp("dataSource",e.job.steps),Tv(19),Mp("matHeaderRowDef",e.displayedStepCols),Tv(),Mp("matRowDefColumns",e.displayedStepCols);}}function Va(a,o){a&1&&(fi(0,"th",27),vD(1,"Variable"),Sc());}function Oa(a,o){if(a&1&&(fi(0,"td",28),vD(1),Sc()),a&2){let e=o.$implicit;Tv(),Kp(e.key);}}function za(a,o){a&1&&(fi(0,"th",27),vD(1,"Value"),Sc());}function Ja(a,o){if(a&1&&(fi(0,"td",28),vD(1),Sc()),a&2){let e=o.$implicit;Tv(),Kp(e.value);}}function Ha(a,o){a&1&&(fi(0,"th",27),vD(1,"Actions"),Sc());}function Ga(a,o){if(a&1){let e=PE();fi(0,"td",28)(1,"button",30),Op("click",function(){let t=du(e).$implicit,i=$E(4);return fu(i.deleteEnvVar(t.envVarId))}),fi(2,"mat-icon"),vD(3,"delete"),Sc()()();}}function Qa(a,o){a&1&&Np(0,"tr",31);}function Wa(a,o){a&1&&Np(0,"tr",32);}function qa(a,o){if(a&1&&(fi(0,"table",16),Rc(1,37),Ep(2,Va,2,0,"th",18)(3,Oa,2,1,"td",19),kc(),Rc(4,38),Ep(5,za,2,0,"th",18)(6,Ja,2,1,"td",19),kc(),Rc(7,24),Ep(8,Ha,2,0,"th",18)(9,Ga,4,0,"td",19),kc(),Ep(10,Qa,1,0,"tr",25)(11,Wa,1,0,"tr",26),Sc()),a&2){let e=$E(3);Mp("dataSource",e.job.envVars),Tv(10),Mp("matHeaderRowDef",e.displayedEnvCols),Tv(),Mp("matRowDefColumns",e.displayedEnvCols);}}function $a(a,o){a&1&&(fi(0,"p",36),vD(1,"No environment variables defined."),Sc());}function Ua(a,o){if(a&1){let e=PE();fi(0,"mat-tab",11)(1,"div",14)(2,"div",33)(3,"mat-form-field",5)(4,"mat-label"),vD(5,"Variable Name"),Sc(),fi(6,"input",34),th$1("ngModelChange",function(t){du(e);let i=$E(2);return DD(i.newEnvKey,t)||(i.newEnvKey=t),fu(t)}),Sc(),uI(),Sc(),fi(7,"mat-form-field",5)(8,"mat-label"),vD(9,"Value"),Sc(),fi(10,"input",35),th$1("ngModelChange",function(t){du(e);let i=$E(2);return DD(i.newEnvValue,t)||(i.newEnvValue=t),fu(t)}),Sc(),uI(),Sc(),fi(11,"button",13),Op("click",function(){du(e);let t=$E(2);return fu(t.addEnvVar())}),fi(12,"mat-icon"),vD(13,"add"),Sc(),vD(14," Add "),Sc()(),CE(15,qa,12,3,"table",16)(16,$a,2,0,"p",36),Sc()();}if(a&2){let e=$E(2);Tv(6),eh$1("ngModel",e.newEnvKey),fI(),Tv(4),eh$1("ngModel",e.newEnvValue),fI(),Tv(5),bE(e.job.envVars.length>0?15:16);}}function Za(a,o){if(a&1&&(fi(0,"div",43),vD(1),Sc()),a&2){let e=o.$implicit;Tv(),Kp(e);}}function Ka(a,o){if(a&1&&(fi(0,"div",41)(1,"strong"),vD(2,"Next fire times:"),Sc(),NE(3,Za,2,1,"div",43,_E),Sc()),a&2){let e=$E(3);Tv(3),SE(e.scheduleNextFires);}}function Xa(a,o){if(a&1){let e=PE();fi(0,"button",13),Op("click",function(){du(e);let t=$E(3);return fu(t.saveSchedule())}),vD(1,"Create Schedule"),Sc();}}function Ya(a,o){if(a&1){let e=PE();fi(0,"button",13),Op("click",function(){du(e);let t=$E(3);return fu(t.saveSchedule())}),vD(1,"Update Schedule"),Sc(),fi(2,"button",15),Op("click",function(){du(e);let t=$E(3);return fu(t.toggleSchedule())}),vD(3),Sc(),fi(4,"button",44),Op("click",function(){du(e);let t=$E(3);return fu(t.deleteSchedule())}),vD(5,"Delete Schedule"),Sc();}if(a&2){let e=$E(3);Tv(3),Oc$1(" ",e.scheduleEnabled?"Disable":"Enable"," Schedule ");}}function ei(a,o){if(a&1){let e=PE();fi(0,"mat-tab",12)(1,"div",14)(2,"mat-form-field",5)(3,"mat-label"),vD(4,"Cron Expression"),Sc(),fi(5,"input",39),th$1("ngModelChange",function(t){du(e);let i=$E(2);return DD(i.scheduleCron,t)||(i.scheduleCron=t),fu(t)}),Sc(),uI(),fi(6,"button",40),Op("click",function(){du(e);let t=$E(2);return fu(t.validateCron())}),fi(7,"mat-icon"),vD(8,"fact_check"),Sc()()(),CE(9,Ka,5,0,"div",41),fi(10,"div",42),CE(11,Xa,2,0,"button",9)(12,Ya,6,1),Sc()()();}if(a&2){let e=$E(2);Tv(5),eh$1("ngModel",e.scheduleCron),fI(),Tv(4),bE(e.scheduleNextFires.length>0?9:-1),Tv(2),bE(e.job.schedule?12:11);}}function ti(a,o){if(a&1){let e=PE();fi(0,"div",1)(1,"button",2),Op("click",function(){du(e);let t=$E();return fu(t.goBack())}),fi(2,"mat-icon"),vD(3,"arrow_back"),Sc()(),fi(4,"h2"),vD(5),Sc()(),fi(6,"mat-tab-group")(7,"mat-tab",3)(8,"form",4)(9,"mat-form-field",5)(10,"mat-label"),vD(11,"Job Name"),Sc(),Np(12,"input",6),uI(),CE(13,va,2,0,"mat-error"),Sc(),fi(14,"mat-form-field",5)(15,"mat-label"),vD(16,"Description"),Sc(),Np(17,"textarea",7),uI(),Sc(),fi(18,"mat-form-field",5)(19,"mat-label"),vD(20,"Working Directory"),Sc(),Np(21,"input",8),uI(),CE(22,xa,2,0,"mat-error"),Sc(),CE(23,ya,2,0,"button",9)(24,Ca,2,0,"button",9),Sc()(),CE(25,ja,27,5,"mat-tab",10),CE(26,Ua,17,3,"mat-tab",11),CE(27,ei,13,3,"mat-tab",12),Sc();}if(a&2){let e=$E();Tv(5),Kp(e.job?"Edit: "+e.job.jobName:"New Job"),Tv(3),Mp("formGroup",e.generalForm),Tv(4),fI(),Tv(),bE(e.generalForm.get("jobName")?.invalid&&e.generalForm.get("jobName")?.touched?13:-1),Tv(4),fI(),Tv(4),fI(),Tv(),bE(e.generalForm.get("workingDir")?.invalid&&e.generalForm.get("workingDir")?.touched?22:-1),Tv(),bE(e.jobId?23:24),Tv(2),bE(e.job?25:-1),Tv(),bE(e.job?26:-1),Tv(),bE(e.job?27:-1);}}function ni(a,o){a&1&&(fi(0,"div",0),vD(1,"Loading..."),Sc());}var Bn=class a$1{fb=T(eh);jobService=T(a);systemService=T(n);snackBar=T(Mt);dialog=T(Ge);route=T(G);router=T(ce);jobId=null;job=null;loading=true;scheduleNextFires=[];generalForm=this.fb.group({jobName:["",br.required],description:[""],workingDir:["",br.required]});displayedStepCols=["stepOrder","stepName","stepType","continueOnFailure","enabled","actions"];displayedEnvCols=["key","value","actions"];newEnvKey="";newEnvValue="";scheduleCron="";scheduleEnabled=false;ngOnInit(){let o=this.route.snapshot.paramMap.get("id");o?(this.jobId=+o,this.loadJob()):this.loading=false;}loadJob(){this.jobId!=null&&this.jobService.getJob(this.jobId).subscribe({next:o=>{o.status==="SUCCESS"&&(this.job=o.data,this.generalForm.patchValue({jobName:this.job.jobName,description:this.job.description,workingDir:this.job.workingDir}),this.job.schedule&&(this.scheduleCron=this.job.schedule.cronExpression,this.scheduleEnabled=this.job.schedule.enabled,this.systemService.validateCron(this.scheduleCron).subscribe({next:e=>{e.status==="SUCCESS"&&e.data.valid&&(this.scheduleNextFires=e.data.nextFireTimes);}}))),this.loading=false;},error:()=>{this.loading=false;}});}saveGeneral(){if(this.generalForm.invalid||this.jobId==null)return;let o=this.generalForm.value;this.jobService.updateJob(this.jobId,{jobName:o.jobName,description:o.description,workingDir:o.workingDir}).subscribe({next:e=>{e.status==="SUCCESS"&&(this.snackBar.open("Job updated","Dismiss",{duration:3e3}),this.loadJob());}});}openStepForm(o){let e={stepId:o?.stepId,stepName:o?.stepName??"",stepOrder:o?.stepOrder??this.job?.steps.length??0,stepType:o?.stepType??"JAVA_EXEC",stepConfig:o?.stepConfig??"{}",continueOnFailure:o?.continueOnFailure??false,enabled:o?.enabled??true};this.dialog.open(ze,{data:e,width:"550px"}).afterClosed().subscribe(n=>{n&&this.jobId!=null&&(n.stepId?this.jobService.updateStep(this.jobId,n.stepId,n).subscribe({next:()=>this.loadJob()}):this.jobService.addStep(this.jobId,n).subscribe({next:()=>this.loadJob()}));});}deleteStep(o){this.jobId!=null&&this.dialog.open(Ye$1,{data:{title:"Delete Step",message:`Delete step "${o.stepName}"?`,confirmButton:"Delete"}}).afterClosed().subscribe(e=>{!e||this.jobId==null||this.jobService.deleteStep(this.jobId,o.stepId).subscribe({next:()=>this.loadJob()});});}addEnvVar(){!this.newEnvKey.trim()||!this.newEnvValue.trim()||this.jobId==null||this.jobService.addEnvVar(this.jobId,{key:this.newEnvKey,value:this.newEnvValue}).subscribe({next:()=>{this.newEnvKey="",this.newEnvValue="",this.loadJob();}});}deleteEnvVar(o){this.jobId!=null&&this.jobService.deleteEnvVar(this.jobId,o).subscribe({next:()=>this.loadJob()});}validateCron(){this.scheduleCron&&this.systemService.validateCron(this.scheduleCron).subscribe({next:o=>{o.status==="SUCCESS"&&(o.data.valid?(this.scheduleNextFires=o.data.nextFireTimes,this.snackBar.open("Cron expression is valid","Dismiss",{duration:3e3})):this.snackBar.open("Invalid cron expression","Dismiss",{duration:3e3,panelClass:"error-snackbar"}));}});}saveSchedule(){this.jobId==null||!this.scheduleCron||(this.job?.schedule?this.jobService.updateSchedule(this.jobId,this.scheduleCron).subscribe({next:()=>{this.loadJob(),this.snackBar.open("Schedule updated","Dismiss",{duration:3e3});}}):this.jobService.createSchedule(this.jobId,this.scheduleCron).subscribe({next:()=>{this.loadJob(),this.snackBar.open("Schedule created","Dismiss",{duration:3e3});}}));}toggleSchedule(){this.jobId!=null&&(this.scheduleEnabled?this.jobService.disableSchedule(this.jobId).subscribe({next:()=>this.loadJob()}):this.jobService.enableSchedule(this.jobId).subscribe({next:()=>this.loadJob()}));}deleteSchedule(){this.jobId!=null&&this.dialog.open(Ye$1,{data:{title:"Delete Schedule",message:"Remove the schedule for this job?",confirmButton:"Delete"}}).afterClosed().subscribe(o=>{!o||this.jobId==null||this.jobService.deleteSchedule(this.jobId).subscribe({next:()=>this.loadJob()});});}createNewJob(){if(this.generalForm.invalid)return;let o=this.generalForm.value;this.jobService.createJob({jobName:o.jobName,description:o.description,workingDir:o.workingDir}).subscribe({next:e=>{e.status==="SUCCESS"&&this.router.navigate(["/jobs",e.data.jobId]);}});}goBack(){this.router.navigate(["/jobs"]);}static \u0275fac=function(e){return new(e||a$1)};static \u0275cmp=XI({type:a$1,selectors:[["app-job-detail"]],decls:2,vars:1,consts:[[1,"loading"],[1,"header-row"],["mat-icon-button","","matTooltip","Back",3,"click"],["label","General"],[1,"tab-form",3,"formGroup"],["appearance","outline"],["matInput","","formControlName","jobName","required",""],["matInput","","formControlName","description","rows","3"],["matInput","","formControlName","workingDir","required",""],["mat-flat-button","","color","primary"],[3,"label"],["label","Env Variables"],["label","Schedule"],["mat-flat-button","","color","primary",3,"click"],[1,"tab-form"],["mat-stroked-button","",3,"click"],["mat-table","",3,"dataSource"],["matColumnDef","stepOrder"],["mat-header-cell","",4,"matHeaderCellDef"],["mat-cell","",4,"matCellDef"],["matColumnDef","stepName"],["matColumnDef","stepType"],["matColumnDef","continueOnFailure"],["matColumnDef","enabled"],["matColumnDef","actions"],["mat-header-row","",4,"matHeaderRowDef"],["mat-row","",4,"matRowDef","matRowDefColumns"],["mat-header-cell",""],["mat-cell",""],["mat-icon-button","","matTooltip","Edit",3,"click"],["mat-icon-button","","matTooltip","Delete","color","warn",3,"click"],["mat-header-row",""],["mat-row",""],[1,"add-env-row"],["matInput","","placeholder","MY_VAR",3,"ngModelChange","ngModel"],["matInput","","placeholder","/some/path",3,"ngModelChange","ngModel"],[1,"empty-msg"],["matColumnDef","key"],["matColumnDef","value"],["matInput","","placeholder","0 0 2 * * *",3,"ngModelChange","ngModel"],["mat-icon-button","","matSuffix","","matTooltip","Validate cron",3,"click"],[1,"next-fires"],[1,"schedule-actions"],[1,"fire-time"],["mat-stroked-button","","color","warn",3,"click"]],template:function(e,n){e&1&&CE(0,ti,28,8)(1,ni,2,0,"div",0),e&2&&bE(n.loading?1:0);},dependencies:[Xi,nh,Qf,To,Xf,qf,$o,Oc,xc,th,Tc,Pn,it,Rn,F,jt,we,Ht,Qt,Ke$1,Ge$1,vg,bg,pu,Ci,Si,Zt,Ut,Qt$1,Kt,Wt,Vt,Xt,$t,qt,Gt,Yt,Oe,Xt$1,Ue,Ji,Xi$1,Yt$1,mt],styles:[".header-row[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;margin-bottom:16px}.header-row[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{margin:0}.tab-form[_ngcontent-%COMP%]{padding:16px;display:flex;flex-direction:column;gap:16px}.add-env-row[_ngcontent-%COMP%]{display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap}.schedule-actions[_ngcontent-%COMP%]{display:flex;gap:12px;flex-wrap:wrap}.next-fires[_ngcontent-%COMP%]{padding:8px 0}.fire-time[_ngcontent-%COMP%]{padding:2px 0;color:var(--mat-sys-on-surface-variant)}.empty-msg[_ngcontent-%COMP%]{color:var(--mat-sys-on-surface-variant);font-style:italic}.loading[_ngcontent-%COMP%]{text-align:center;padding:48px;color:var(--mat-sys-on-surface-variant)}table[_ngcontent-%COMP%]{width:100%}"]})};export{Bn as JobDetailComponent};